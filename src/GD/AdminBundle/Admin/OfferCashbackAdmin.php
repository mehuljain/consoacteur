...
/*
 *  This class represents the CRUD definition for Cashback Offers.
 *  Only records with offer type as OFFER_TYPE_CASHBACK are fetched
 */
class OfferCashbackAdmin extends SonataAdmin
{
    protected $baseRouteName = 'offer_cashback';
    protected $baseRoutePattern = 'offers/cashback';
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('type', 'hidden', array('attr' => array('value' => Offer::OFFER_TYPE_CASHBACK)))
            ...
            ->add('userGainPercentage', 'percent', array('type' => 'integer', 'precision' => '2', 'help' => $this->translator->trans('offer.usergainpercentnotification.message')))
            ...
            ->add('isCurrent')
            ->add('cashbackValuePercentage', 'percent', array('required' => false, 'type' => 'integer', 'precision' => '2', 'help' => $this->translator->trans('cashbackpercentage.notification.message')))
            ->add('cashbackValueAmount', null, array('required' => false, 'help' => $this->translator->trans('cashbackamount.notification.message') ))
            ...
            // TODO: Replace the above affiliatePartner code with something like this after updating deps.lock . ->add('merchant.affiliatePartner', null, array('read_only' => true))
            ;
    }
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.type = :type')
            ->setParameter('type', Offer::OFFER_TYPE_CASHBACK);
