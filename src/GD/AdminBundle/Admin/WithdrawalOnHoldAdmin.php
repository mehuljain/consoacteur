...
/*
 *  This class represents the CRUD definition for the Withdrawal entity with status as TRANSACTION_STATUS_ON_HOLD
 */
class WithdrawalOnHoldAdmin extends SonataAdmin
{
    protected $withdrawalType;
    protected $baseRouteName = 'withdrawal_on_hold';
    protected $baseRoutePattern = 'withdrawal/onhold';
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.status = '.Transaction::TRANSACTION_STATUS_ON_HOLD);
