...
/*
 *  This class represents the CRUD definition for Code Promo Offers.
 *  Only records with offer type as OFFER_TYPE_CODE_PROMO are fetched.
 */
class OfferCodePromoAdmin extends SonataAdmin
{
    protected $baseRouteName = 'offer_code_promo';
    protected $baseRoutePattern = 'offers/code-promo';
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('type', 'hidden', array('attr' => array('value' => Offer::OFFER_TYPE_CODE_PROMO)))
            ...
            ->add('userGainValue', null, array('attr' => array('class' => 'translatable'), 'help' =>  $this->translator->trans('codepromovalue.notification.message') ))
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.type = :type')
            ->setParameter('type', Offer::OFFER_TYPE_CODE_PROMO);
