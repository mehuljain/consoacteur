...
/*
 *  This class represents the CRUD definition for Archived Customers (User entity)
 *  Only customers (users that register from the frontend of the website) that are archived are diplayed. 
 *  Only records that have the isAdminUser flag set as false and isArchived flag set as true are displayed.
 */
class CustomersArchivedAdmin extends SonataAdmin
{
    protected $baseRouteName = 'customers_archived';
    protected $baseRoutePattern = 'customers/archived';
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.isAdminUser = false AND o.isArchived = true');
    ...
    {
        return 'GDAdminBundle:Customer:archive.html.twig';
    }
}
