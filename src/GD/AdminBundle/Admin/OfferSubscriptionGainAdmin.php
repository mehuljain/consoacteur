...
/*
 *  This class represents the CRUD definition for Subscription Gain Offers.
 *  Only records with offer type as OFFER_TYPE_SUBSCRIPTION_GAIN are fetched.
 */
class OfferSubscriptionGainAdmin extends SonataAdmin
{
    protected $baseRouteName = 'offer_subscription_gain';
    protected $baseRoutePattern = 'offers/subscription-gain';
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->add('type', 'hidden', array('attr' => array('value' => Offer::OFFER_TYPE_SUBSCRIPTION_GAIN)))
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.type = :type')
            ->setParameter('type', Offer::OFFER_TYPE_SUBSCRIPTION_GAIN);
