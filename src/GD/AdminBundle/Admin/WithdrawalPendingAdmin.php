...
/*
 *  This class represents the CRUD definition for the Withdrawal entity with status as TRANSACTION_STATUS_PAYMENT_REQUESTED
 */
class WithdrawalPendingAdmin extends SonataAdmin
{
    protected $withdrawalType;

    protected $baseRouteName = 'withdrawal_pending';
    protected $baseRoutePattern = 'withdrawal/pending';
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        switch($this->withdrawalType){
            ...
            case(Withdrawal::WITHDRAWAL_TYPE_BANK_2):
                $formMapper
                    ...
                    ->add('address', null, array('read_only' => true))
                    ->add('accountNumber', null, array('attr' => array('readonly' => true)))
                ;
                break;
        ...
        $formMapper
            ->add('amount', null, array('read_only' => true))
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.status = '.Transaction::TRANSACTION_STATUS_PAYMENT_REQUESTED);
    ...
    {
        return 'GDAdminBundle:Withdrawal:withdrawal_pending_base_edit.html.twig';
    }
    
    /*
     *  A partial URL is needed by the controller to create hyperlinks to the corresponding Transaction 
     *  objects in the Edit view
     */
