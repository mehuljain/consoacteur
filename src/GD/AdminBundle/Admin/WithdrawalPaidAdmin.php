...
/*
 *  This class represents the CRUD definition for the Withdrawal entity with status as TRANSACTION_STATUS_PAID
 */
class WithdrawalPaidAdmin extends SonataAdmin
{
    protected $withdrawalType;
    protected $baseRouteName = 'withdrawal_paid';
    protected $baseRoutePattern = 'withdrawal/paid';
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->where('o.status = '.Transaction::TRANSACTION_STATUS_PAID);
